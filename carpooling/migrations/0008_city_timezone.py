...
def set_timezone_by_region(apps, schema_editor):
    """
    Автоматически устанавливает часовой пояс для городов на основе региона.
    """
    City = apps.get_model('carpooling', 'City')
    
    # Соответствие регионов и часовых поясов
    region_timezone_map = {
        # UTC+2 - Калининград
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('carpooling', '0007_trip_origin_destination_fk'),
    ]
